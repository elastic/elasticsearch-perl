...
#===================================
    ...
    elsif ( blessed($src) && $src->isa('Search::Elasticsearch::Client::2_0::Scroll') ) {
        my $scroll = $src;
        $src = sub {
    ...
    # async scroll
    if ( blessed($src) && $src->isa('Search::Elasticsearch::Client::2_0::Async::Scroll') ) {
        $promise = $src->start;
    }
    else {
...
The L<Search::Elasticsearch::Client::2_0::Async::Bulk> module acts as a queue, buffering up actions
...
The C<bulk_helper> method loads L<Search::Elasticsearch::Client::2_0::Async::Bulk>,
...
L<Search::Elasticsearch::Client::2_0::Async::Scroll/new()> to create a new scrolled search.
