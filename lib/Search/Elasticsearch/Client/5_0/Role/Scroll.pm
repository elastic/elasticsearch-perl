package Search::Elasticsearch::Client::5_0::Role::Scroll;
...
# ABSTRACT: Provides common functionality to L<Search::Elasticsearch::Client::5_0::Scroll> and L<Search::Elasticsearch::Client::5_0::Async::Scroll>
