package Search::Elasticsearch::Client::1_0::Async::Scroll;
...
with 'Search::Elasticsearch::Role::Is_Async',
    'Search::Elasticsearch::Client::1_0::Role::Scroll';
...
This class does L<Search::Elasticsearch::Client::1_0::Role::Scroll> and
...
L<Search::Elasticsearch::Client::1_0::Async::Bulk/reindex()> method.
...
L<Search::Elasticsearch::Client::1_0::Async::Scroll> class and calls L</new()>,
...
=item * L<Search::Elasticsearch::Client::1_0::Async::Bulk/reindex()>
