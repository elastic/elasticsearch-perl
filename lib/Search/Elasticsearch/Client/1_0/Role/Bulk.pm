...
package Search::Elasticsearch::Client::1_0::Role::Bulk;
...
# ABSTRACT: Provides common functionality to L<Elasticseach::Client::1_0::Bulk> and L<Search::Elasticsearch::Client::1_0::Async::Bulk>
