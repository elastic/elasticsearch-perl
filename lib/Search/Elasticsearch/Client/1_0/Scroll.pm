...
package Search::Elasticsearch::Client::1_0::Scroll;
...
L<Search::Elasticsearch::Client::1_0::Bulk/reindex()> method.
...
L<Search::Elasticsearch::Client::1_0::Scroll> class and calls L</new()>,
...
=item * L<Search::Elasticsearch::Client::1_0::Bulk/reindex()>
